...
public class PerformanceCommand implements SubCommand {
    ...
    public boolean execute(CommandSender sender, String[] args) {
        if (args.length < 2) {
            ...
            plugin.sendPlayerMessage(sender, "&#B0E0E6/yafk perf stats &#ADD8E6- 查看性能统计");
            plugin.sendPlayerMessage(sender, "&#B0E0E6/yafk perf reset &#ADD8E6- 重置性能统计");
            return true;
        }
        ...
        switch (args[1].toLowerCase()) {
            ...
            case "reset":
                ...
                break;
            default:
                plugin.sendPlayerMessage(sender, "&#6CA6CD未知命令！使用 /yafk perf 查看帮助");
                break;
        }
        return true;
    }
